# Generated by Powerlevel10k configuration wizard on 2021-08-23 at 18:07 UTC.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 41849.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode, dark,
...
#
# Config for Powerlevel10k with rainbow powerline prompt style. Type `p10k configure` to generate
